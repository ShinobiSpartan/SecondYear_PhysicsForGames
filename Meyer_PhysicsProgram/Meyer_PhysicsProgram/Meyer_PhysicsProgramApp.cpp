...
bool Meyer_PhysicsProgramApp::startup() {
	...
	// Drawing the balls
	m_physicsScene->addActor(new Circle(glm::vec2(50, -30), glm::vec2(-30, 0), 5, 5, glm::vec4(1, 0, 1, 1)));
	m_physicsScene->addActor(new Circle(glm::vec2(30, -30), glm::vec2(-10, 0), 5, 5, glm::vec4(1, 0, 0, 1)));

	// Drawing the box
	//m_physicsScene->addActor(new Box(glm::vec2(-20, 0), glm::vec2(10, 0), 5, glm::vec2(5, 5), glm::vec4(1, 0, 1, 1)));
	//m_physicsScene->addActor(new Box(glm::vec2(20, 0), glm::vec2(-10, 0), 5, glm::vec2(5, 5), glm::vec4(0, 0, 1, 1)));
